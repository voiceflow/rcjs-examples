...
9. Run `yarn` to install the runtime client SDK, `@voiceflow/runtime-client-js`

10. Depending on the project, you can start the project with `node index.js` or `yarn start`. 
